...
function handleTouchStart(e) {
    ...
    // Establecer un temporizador para distinguir entre toque y arrastre
...
function handleTouchMove(e) {
    ...
    // Si hay movimiento significativo, es un arrastre
...
function handleTouchEnd(e) {
    ...
    // Si era un toque rápido (no arrastre), disparar
...
function handleClick(e) {
    // Solo disparar si no fue parte de un arrastre
    if (!touchControls.isDragging) {
        player.shoot();
    }
}
